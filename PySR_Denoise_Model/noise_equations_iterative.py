...
def varyingnoiserandomConservation():
    ...
    with open("y_results_noise_conservation_i.txt", "w") as file:
...
def varyingnoiserandomNewtonSecondLaw():
    ...
    # save y to a file then later parse through it 
    with open("y_results_noise_Newtons_Second_Law_i.txt", "w") as file:
        file.write(",".join(map(str, y_results)))
...
def varyingnoiserandomNewtonFirstLaw():
    ...
    # save y to a file then later parse through it 
    with open("y_results_noise_Newtons_First_Law_i.txt", "w") as file:
        file.write(",".join(map(str, y_results)))
...
def varyingnoiserandomNewtonThirdLaw():
    ...
    # save y to a file then later parse through it 
    with open("y_results_noise_Newtons_Third_Law_i.txt", "w") as file:
        file.write(",".join(map(str, y_results)))
...
def varyingnoiserandomSimpleHarmoicMotion():
    ...
    # save y to a file then later parse through it 
    with open("y_results_noise_Simple_Harmonic_Motion_i.txt", "w") as file:
        file.write(",".join(map(str, y_results)))
...
def varyingnoiserandomRutherford():
    ...
    # save y to a file then later parse through it 
    with open("y_results_noise_Rutherford_i.txt", "w") as file:
        file.write(",".join(map(str, y_results)))
