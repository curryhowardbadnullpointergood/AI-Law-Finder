...
#    'y_results_noise_conservation.txt'
#]) 
#
#
...
#
#
#file_path = './y_results_noise_conservation.txt'
#
...
#plt.plot(x_values, y_results, marker='o', linestyle='-', color='b', label="Noise vs Value")
#plt.xlabel("Noise")
#plt.ylabel("Value of Noise")
#plt.title("Noise vs Value Plot")
#plt.legend()
#plt.grid(True)
#
#
## will save a pdf for latex it is good?? switch to jpg if file size is too high
#plt.savefig("noise_conservation.pdf")
#
#
